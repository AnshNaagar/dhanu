...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/AnshNaagar")
...
# All Images Of Dhanu Music Player // @Celestial_XD
START_IMG_URL = getenv("START_IMG_URL", f"https://graph.org/file/2cfaad1b0d034fcb642bc.jpg")
